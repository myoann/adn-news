...
app.controller('rechercherCotisantController', function($scope,$http){

    $scope.rechercher = function(){
        var url  = "recherche.php";
x
        $http.get(url) //http://localhost/angular/backend.php
            .then(function (response) {
                $scope.listeCotisants = response.data.cotisants;
            });

    };

    $scope.rechercherDetail = function(idCotisant){
        $http.get("detail.php?idCotisant="+idCotisant) //http://localhost/angular/backend.php
            .then(function (response) {
                console.log(response.data);
                $scope.listeExercices = response.data.exercices;
                $scope.listeRisquesTI = response.data.risquesTI;
            });
    };
